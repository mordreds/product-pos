...
class Reports extends MY_Controller
{
    ...
    function profit_loss_details()
    {
        $this->load->model('Reports_model');
        $this->data['result'] = $this->Reports_model->AllStoresProfitLossDetails($startDate="2021-01-01", $endDate="2021-01-08");

        $bc = array(array('link' => '#', 'page' => lang('reports')), array('link' => '#', 'page' => lang('profit_loss_details')));
        $meta = array('page_title' => lang('profit_loss_details'), 'bc' => $bc);
        $this->page_construct('reports/profit_loss_details', $this->data, $meta);
    }
